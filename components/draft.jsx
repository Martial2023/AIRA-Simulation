...
// const TrafficSimulation = () => {
//   const sketchRef = useRef();
//   const [trafficDensity, setTrafficDensity] = useState(60); // Valeur initiale pour le slider (60 frames = 1 véhicule par seconde)
//   const simulationState = useRef({
//     vehicles: [],
//     trafficLights: [],
//     vehicleSpawnTimer: 0,
//     vehicleSpawnInterval: 60, // Par défaut : 1 véhicule par seconde (60 frames à 60 FPS)
//   });
...
//         // Générer de nouveaux véhicules en fonction de la densité
//         simulationState.current.vehicleSpawnTimer += 1;
//         if (simulationState.current.vehicleSpawnTimer >= simulationState.current.vehicleSpawnInterval) {
//           spawnVehicle(p);
//           simulationState.current.vehicleSpawnTimer = 0;
//         }
//       };
//     };
...
//   // Mettre à jour l'intervalle de génération des véhicules en fonction du slider
//   useEffect(() => {
//     simulationState.current.vehicleSpawnInterval = trafficDensity;
//   }, [trafficDensity]);
...
//   return (
//     <div className="min-h-screen bg-gray-100 flex flex-col items-center py-8">
//       <h1 className="text-4xl font-bold text-gray-800 mb-6">Traffic Simulation</h1>
//       <div className="bg-white shadow-lg rounded-lg p-6 mb-6">
//         <div ref={sketchRef} className="mx-auto"></div>
//       </div>
//       <div className="w-full max-w-md">
...
//         </div>
//         <div className="mt-6">
//           <h3 className="text-lg font-medium text-gray-600 mb-2">Traffic Density</h3>
//           <input
//             type="range"
//             min="10"
//             max="100"
